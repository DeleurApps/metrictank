...
func TestMarshalUnmarshalMdWithCwrs(t *testing.T) {
	v := MdWithCwrs{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgMdWithCwrs(b *testing.B) {
	v := MdWithCwrs{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgMdWithCwrs(b *testing.B) {
	v := MdWithCwrs{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalMdWithCwrs(b *testing.B) {
	v := MdWithCwrs{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeMdWithCwrs(t *testing.T) {
	v := MdWithCwrs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeMdWithCwrs(b *testing.B) {
	v := MdWithCwrs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeMdWithCwrs(b *testing.B) {
	v := MdWithCwrs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
