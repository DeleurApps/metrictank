...
func testIncResolution(t *testing.T, inData []whisper.Point, expectedResult map[schema.Method][]whisper.Point, method schema.Method, fakeAvg bool, inRes, outRes, rawRes uint32) {
	t.Helper()
	outData := incResolution(inData, method, fakeAvg, inRes, outRes, rawRes)
...
func TestIncResolutionUpToTime(t *testing.T) {
	...
	*importUpTo = uint(5)
	testIncResolution(t, inData, expectedResult, schema.Avg, true, 10, 5, 1)
...
func TestIncResolutionFakeAvgNonFactorResolutions(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Avg, true, 10, 3, 1)
}
...
func TestIncFakeAvgResolutionStrangeRawRes(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Avg, true, 30, 10, 3)
}
...
func TestIncResolutionSimpleMax(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Max, false, 10, 5, 1)
}
...
func TestIncResolutionSimpleLast(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Lst, false, 10, 5, 1)
}
...
func TestIncResolutionSimpleMin(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Min, false, 10, 5, 1)
}
...
func TestIncResolutionSimpleAvg(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Avg, false, 10, 5, 1)
}
...
func TestIncResolutionSimpleSum(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Sum, false, 10, 5, 1)
}
...
func TestIncResolutionNonFactorResolutions(t *testing.T) {
	...
	testIncResolution(t, inData, expectedResult, schema.Max, false, 10, 3, 1)
}
...
func testDecResolution(t *testing.T, inData []whisper.Point, expectedResult map[schema.Method][]whisper.Point, method schema.Method, fakeAvg bool, inRes, outRes, rawRes uint32) {
	t.Helper()
	outData := decResolution(inData, method, fakeAvg, inRes, outRes, rawRes)
...
func TestDecResolutionSimpleAvg(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Avg, false, 10, 30, 1)
}
...
func TestDecResolutionSimpleFakeAvg(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Avg, true, 10, 30, 1)
}
...
func TestDecResolutionSimpleSum(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Sum, false, 10, 30, 1)
}
...
func TestDecResolutionSimpleLast(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Lst, false, 10, 30, 1)
}
...
func TestDecResolutionSimpleMax(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Max, false, 10, 30, 1)
}
...
func TestDecResolutionSimpleMin(t *testing.T) {
	...
	testDecResolution(t, getSimpleInData(), expectedResult, schema.Min, false, 10, 30, 1)
}
...
func TestDecResolutionUpToTime(t *testing.T) {
	...
	*importUpTo = uint(40)
	testDecResolution(t, inData, expectedResult, schema.Sum, false, 10, 30, 5)
	*importUpTo = math.MaxUint32
}
...
func TestDecResolutionAvg(t *testing.T) {
	...
	testDecResolution(t, inData, expectedResult, schema.Avg, false, 10, 30, 1)
}
...
func TestDecNonFactorResolutions(t *testing.T) {
	...
	testDecResolution(t, inData, expectedResult, schema.Avg, false, 10, 15, 1)
}
...
func TestDecResolutionWithGapsAvg(t *testing.T) {
	...
	testDecResolution(t, getGapData(), expectedResult, schema.Avg, false, 10, 20, 1)
}
...
func TestDecResolutionWithGapsFakeAvg(t *testing.T) {
	...
	testDecResolution(t, getGapData(), expectedResult, schema.Avg, true, 10, 20, 1)
}
...
func TestDecResolutionWithGapsSum(t *testing.T) {
	...
	testDecResolution(t, getGapData(), expectedResult, schema.Sum, false, 10, 20, 1)
}
...
func TestDecFakeAvgNonFactorResolutions(t *testing.T) {
	...
	testDecResolution(t, inData, expectedResult, schema.Sum, false, 10, 15, 1)
}
...
func TestDecResolutionFakeAvgOutOfOrder(t *testing.T) {
	...
	testDecResolution(t, inData, expectedResult, schema.Sum, false, 10, 30, 1)
}
